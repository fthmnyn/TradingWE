    ...
    <div className="stock-market" style={{
      ...
      <div className="container" style={{
        ...
        <h1 className="main-title" style={{
            ...
            fontSize: '2rem',
        }}>Stock market analysis for the serious part–time investor</h1>
        <div className="description" style={{
            ...
            fontSize: '1.125rem',
        }}>We use intuitive data visualizations and automated stock analysis to help you understand a stock's fundamentals within minutes.</div>
